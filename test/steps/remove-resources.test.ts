...
function makeTemplate(resources: Record<string, {Type: string; DependsOn?: string | string[]; Properties?: Record<string, unknown>}>, outputs?: Record<string, unknown>): CloudFormationTemplate {
  return {
