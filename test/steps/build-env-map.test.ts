...
function makeLambdaTemplate(functions: Record<string, {env?: Record<string, unknown>; handler?: string; runtime?: string; functionName?: string}>): CloudFormationTemplate {
